...
export const createLeastAuthorityExecutor = (): QualificationExecutor => ({
  ...
  workerId: "pydantic-ai-native-probe",
  execute: async (request: QualificationRequest): Promise<QualificationExecution> => {
    ...
    const scratch = mkdtempSync(join(tmpdir(), "aifsd-pydantic-sandbox-"));
    ...
    if (probe.exitCode !== 0) throw new Error("sandboxed native PydanticAI probe failed");
    ...
    const observations: readonly NativeObservation[] = [
      ...native.observations.map((observation) => ({
        ...
        evidence: evidence(
          "0198d6f0-0000-7000-8000-000000000011" as EvidenceRef["evidenceId"],
          "0198d6f0-0000-7000-9000-000000000011" as EvidenceRef["content"]["resourceId"],
          probe.stdout,
        ),
      })),
      {
        ...
        basis: "pinned-source",
        evidence: evidence(
          "0198d6f0-0000-7000-8000-000000000012" as EvidenceRef["evidenceId"],
          "0198d6f0-0000-7000-9000-000000000012" as EvidenceRef["content"]["resourceId"],
          sourceBytes,
        ),
      },
    ];
    ...
    const boundary = {
      ...
      exitCode: 0 as const,
      evidence: evidence(
        "0198d6f0-0000-7000-8000-000000000013" as EvidenceRef["evidenceId"],
        "0198d6f0-0000-7000-9000-000000000013" as EvidenceRef["content"]["resourceId"],
        policyBytes,
      ),
    };
    return {

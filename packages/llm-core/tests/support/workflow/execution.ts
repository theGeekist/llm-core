/** Test-only controlled workflow proof executor. */
import type { JsonValue, StepId } from "#contracts";
import type { ActionDigest } from "../../../src/features/tooling/runtime";
import { portableState, type RecordedEffect } from "../../../src/features/state/public";
import { registerRecordedEffect } from "../../../src/features/state/runtime";

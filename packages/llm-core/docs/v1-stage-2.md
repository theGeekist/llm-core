...
- Docs: v1-implementation-plan.md, v1-workflow-notes.md
...
[x] Update docs per change: Stage 2 checklist in v1-implementation-plan.md and DX notes in v1-workflow-notes.md.

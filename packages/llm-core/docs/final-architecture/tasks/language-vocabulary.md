...
write_scope:
  ...
  - packages/llm-core/docs/final-architecture/decisions/ADR-012-exact-public-vocabulary.md
  ...
  - packages/llm-core/docs/final-architecture/tasks/language-vocabulary.md
  - packages/llm-core/docs/final-architecture/tasks/specification-*.md
  - packages/llm-core/docs/final-architecture/tasks/adapter-*.md
...
bunx prettier packages/llm-core/docs/final-architecture --check
git diff --check
```

...
- `v1-workflow-notes.md` (canonical overview)
...
- Update `v1-workflow-notes.md` with explicit contract lookup path.
...
- Add a short “Builder lifecycle” section in `v1-workflow-notes.md`.
- Add a one-line example showing `.use(...).build()` in `v1-workflow-notes.md`.
...
Status: completed. See `v1-stage-2.md` for the detailed checklist.
...
Status: completed. See `v1-stage-3.md` for the detailed checklist.
Note: explain() + contract() were completed as part of Stage 3.

## Stage 4 — Recipes + Minimum Capabilities

Status: completed. See `v1-stage-4.md` for the detailed checklist.
...
Status: completed. See `v1-stage-5.md` for the detailed checklist.
...
Status: completed. See `v1-stage-6.md` for the detailed checklist.
...
Status: completed. See `v1-stage-7.md`.
...
Status: completed. See `v1-stage-8.md`.
...
Status: completed. See `v1-stage-8b.md`.
...
Status: completed. See `v1-stage-9.md`.
...
Status: completed. See `v1-stage-10.md`.
...
Status: completed. See `v1-stage-10b.md`.
...
Status: completed. See `v1-stage-11.md`.
...
Status: completed. See `v1-stage-12.md`.
...
Status: completed. See `v1-stage-13.md`.
...
Status: completed. See `v1-stage-14.md`.
...
Status: completed. See `v1-stage-15.md`.
...
Status: planned. See `v1-stage-16.md`.
...
Status: completed. See `v1-stage-17.md`.
...
Status: completed. See `v1-stage-18.md`.
...
Status: completed. See `v1-stage-19.md`.
...
Status: complete. See `v1-stage-20.md`.
...
Status: complete. See `v1-stage-21.md`.

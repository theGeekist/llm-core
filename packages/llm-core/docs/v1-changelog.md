# Architecture v1 changelog (historical)

This file records the retired Architecture v1 stage programme. Its unreleased
items are historical plans, not current `llm-core` commitments. Current
Architecture v2 authority lives in [`final-architecture/`](final-architecture/).

...
Architecture v2 P0 and P1 implementation tasks are complete. Prepare the
versioned release from the verified 19-front package surface; PydanticAI
v2.19.0 remains the exact CI-verified first Python reference runtime.

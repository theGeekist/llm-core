...
| specification-api                     | specifications | done     | coordinator   | codex-root                     | specification-authority                                                                                                   |
| adapter-openspec                      | adapters       | done     | Codex         | codex-root                     | specification-api                                                                                                         |
| adapter-openspec-release              | adapters       | proposed | coordinator   | —                              | adapter-openspec, ADR-010                                                                                                 |
| adapter-pydantic-ai                   | adapters       | done     | Codex         | codex-root                     | specification-api                                                                                                         |
| adapter-pydantic-ai-release           | adapters       | proposed | coordinator   | —                              | adapter-pydantic-ai, ADR-010                                                                                              |
| adapter-ai-sdlc                       | adapters       | done     | Codex         | codex-root                     | specification-api                                                                                                         |
| adapter-ai-sdlc-release               | adapters       | proposed | coordinator   | —                              | adapter-ai-sdlc, ADR-010                                                                                                  |
| adapter-spec-kit                      | adapters       | done     | Codex         | codex-root                     | specification-api                                                                                                         |
| adapter-spec-kit-release              | adapters       | proposed | coordinator   | —                              | adapter-spec-kit, ADR-010                                                                                                 |
| adapter-bmad                          | adapters       | done     | Codex         | codex-root                     | specification-api                                                                                                         |

...
| P0-143 | P0.3  | claimed  | Codex         | codex-root               | P0-100, P0-120, P0-140, P0-160 |
...
Complete review and integration for P0-141 and P0-142 while P0-143 runs, then
claim P0-149. Integrate or freeze docs-v2 before P0-150.

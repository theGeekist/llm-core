...
write_scope:
  ...
  - packages/llm-core/internal/final-architecture/tasks/X1-435-publish-spec-kit-adapter.md
read_scope:
...
# X1-435 — Publish the qualified Spec Kit adapter
...
- X1-430 conformance evidence is complete and names exact file/CLI contracts.

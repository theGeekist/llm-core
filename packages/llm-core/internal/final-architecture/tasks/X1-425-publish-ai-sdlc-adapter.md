...
write_scope:
  ...
  - packages/llm-core/internal/final-architecture/tasks/X1-425-publish-ai-sdlc-adapter.md
read_scope:
...
# X1-425 — Publish the qualified AI-SDLC adapter
...
- X1-420 conformance evidence is complete and pins supported resource versions.

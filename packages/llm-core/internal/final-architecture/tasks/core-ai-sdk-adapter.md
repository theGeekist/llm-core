...
write_scope:
  ...
  - packages/llm-core/internal/final-architecture/tasks/core-ai-sdk-adapter.md
read_scope:
...
# core-ai-sdk-adapter — Convert AI SDK Adapter to Version 7
...
exact AI SDK 7 matrix recorded by core-ai-sdk-packaging.

## Out of scope

Neutral interaction/session orchestration, non-AI-SDK UI projections, root
exports and final legacy-directory deletion. core-interactions owns the architectural UI
projection migration after this task establishes a green AI SDK 7 compatibility
baseline; core-convergence owns final convergence and deletion.
...
- 2026-07-29T19:27:00+08:00 — Claimed by the Codex coordinator after core-ai-sdk-packaging
...
- `832b5f0` / `7098877` — net-zero boundary probe: a qualified-front export
  ...
  worker removed it and deferred that convergence change to core-convergence.
...
### Shared-file request for core-convergence
...
- `packages/llm-core/tests/architecture/public-exports.characterization.test.ts`:
  ...
  convergence commit. core-ai-sdk-adapter deliberately leaves both shared surfaces unchanged.

...
const registry = {
  agent: {
    ...
    extensionPoints: ["beforePlan", "afterToolExec", "beforeAnswer"],
  ...
  rag: {
    ...
    outcomes: OUTCOMES_DEFAULT,
    extensionPoints: ["beforeRetrieve", "afterRetrieve", "beforeAnswer"],
  ...
  eval: {
    ...
    extensionPoints: ["beforeGenerate", "afterScore", "beforeReport"],
  ...
  "hitl-gate": {
    ...
    outcomes: OUTCOMES_DEFAULT,
    extensionPoints: ["beforeGate", "afterGate", "beforeFinalize"],
  ...
  loop: {
    ...
    outcomes: OUTCOMES_DEFAULT,
    extensionPoints: ["beforeIteration", "afterIteration", "beforeTerminate"],
  ...
  ingest: {
    ...
    outcomes: OUTCOMES_NO_HITL,
    extensionPoints: ["beforeChunk", "afterUpsert"],

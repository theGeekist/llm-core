...
const readMessageIsCopied = (input: { message: { isCopied: boolean } }) => input.message.isCopied;
const readMessageIsNotCopied = (input: { message: { isCopied: boolean } }) =>
  !input.message.isCopied;
    ...
    >
      <ActionBarPrimitive.Copy asChild>
        <TooltipIconButton tooltip="Copy">
          <AssistantIf condition={readMessageIsCopied}>
            <CheckIcon />
          </AssistantIf>
          <AssistantIf condition={readMessageIsNotCopied}>
            <CopyIcon />
          </AssistantIf>
        </TooltipIconButton>

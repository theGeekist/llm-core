...
Retrieval, indexing, storage, and memory are neutral feature domains curated
through the `/agent` package surface. Media is curated through `/model`.

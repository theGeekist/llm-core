...
4. constraints require a trusted evaluator and fail closed on throws or non-boolean results;
5. zero eligible bindings and multiple eligible bindings return unresolved outcomes with diagnostics.
